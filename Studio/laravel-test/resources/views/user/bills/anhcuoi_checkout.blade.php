                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="block billing-details">
                            ...
                            <form action="{{ route('submitanhcuoi') }}" method="POST" class=" checkout-form" role="form">
                                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="product-checkout-details">
                            <div class="block">
                                <h4 class="widget-title"><strong />Ảnh Cưới</h4>
                                <ul class="summary-prices">
                                    <li><span>Tổng số lượng:</span> <span class="price">{{$carts2->total_quantity()}}</span>
                                    </li>
                                    <li><span>Giao hàng:</span> <span>Miễn phí</span></li>
                                </ul>
                                <div class="summary-total">
                                    <span>Tổng giá</span> <span>{{$carts2->total_price()}}$</span>
                                </div>
                            </div>
                        </div>
                    </div>
